          ...
          <button
            onClick={() => {
              ...
              if (prev?.type === 'document')
                onCompleteItem(activeItem.lessonId, prev.id);
              setActiveItem({
                lessonId: activeItem.lessonId,
                itemIndex: activeItem.itemIndex - 1,
              });
            }}
          ...
          <button
            onClick={() => {
              ...
              if (next?.type === 'document')
                onCompleteItem(activeItem.lessonId, next.id);
              setActiveItem({
                lessonId: activeItem.lessonId,
                itemIndex: activeItem.itemIndex + 1,
              });
  ...
  return (
    <div>
      <div style={{ padding: '12px 12px 0' }}>
        ...
        <h2 className="lesson-title" style={{ margin: '8px 0 12px' }}>
          {course.title}
        </h2>
      </div>
          ...
          return (
            <div key={lesson.id} className="accordion-item">
              ...
              >
                ...
                {(lessonProgressMap.get(lesson.id) ?? 0) > 0 && (
                  ...
                  {items.map((item, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`lesson-type-icon ${typeClass}${isCompleted ? ' completed' : ''}`}
                        >
                          {item.type === 'task' ? (
                            <svg
                              viewBox="0 0 24 24"
